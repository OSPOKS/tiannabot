...
from Tianabot.utils.filter_groups import karma_negative_group, karma_positive_group
from Tianabot import arq

regex_upvote = r"^((?i)\+|\+\+|\+1|thx|thanx|thanks|pro|cool|good|👍|op)$"
regex_downvote = r"^(\-|\-\-|\-1|👎|noob|weak|gandu|bad)$"
